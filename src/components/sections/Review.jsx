    ...
    const data = [
        {
            ...
            user: "Айгерим",
            avatar: "/assets/images/png/team-1.png",
            district: "Г. Ташкент",
    ...
    return (
        <section >
            <div className=' max-w-[1440px] w-full mx-auto px-[24px] lg:px-[40px] '>
                ...
                <div className="grid grid-cols-2 gap-[20px] pt-[56px] ">

                    <div className='h-[520px] bg-[red]'>
                        <Image src={data[activeItem].img} alt='image' width={669} height={520}  className='h-full object-fill'/>
           </div>
                    <div className='flex flex-col justify-between'>
                        <div>
                            <div className='flex items-center gap-[17px] pb-[24px]'>
                                <Image src={data[activeItem].avatar} alt='image' width={72} height={72} className='rounded-full h-[72px] object-cover ' />
                                <div>
                        ...
                        <div className='flex items-center gap-[20px]'>
                            <span className='bg-[#E2E8F0] w-full h-[4px] inline-flex rounded-full overflow-hidden'>
                                {data.length && data.map((item, index) => (
                                    ...
                                    <span onClick={()=> setActiveItem(index)} style={{ width: Number( 100/data.length)+"%"}} className=
                            ...
                            <div className='flex items-center gap-[16px]'>
                                ...
                                <button className='disabled:opacity-[0.4]' onClick={() => {
                                    setActiveItem(num => activeItem !== data.length && num +1)
                                }}
