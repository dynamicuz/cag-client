...
const IntroSection = () => {
    ...
    console.log(localization.home.intro);

    return (
        <section className="">
            <div className=' max-w-[1440px] w-full mx-auto px-[24px] lg:px-[40px]  flex lg:flex-nowrap flex-wrap'>
                <div className="w-full p-[40px] rounded-[32px] bg-[url(/assets/images/png/intro-bg.png)] bg-center bg-cover bg-no-repeat">
                    <h1 className="font-[700] text-[#fff] uppercase text-[65px] font-oswald">Международная студенческая программа культурного обмена Work&Travel USA</h1>
                    <p className="text-[#fff] text-[20px] w-[600px] mt-[8px] mb-[24px]">Мы создаем возможности для студентов участвовать в программе <b>Work & Travel USA.</b></p>
                    <button className='p-[16px] px-[201px] bg-[#fff] rounded-full text-[#000] text-[20px] mt-[40px] font-[500]'>Подробнее</button>

                    <div className="flex items-center gap-[40px] text-[#fff] mt-[148px]">
                        <a className='text-[18px] font-[500] text-[#fff] flex gap-[8px]' href="#"><svg width="28" height="28" viewBox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg">
