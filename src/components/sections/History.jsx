        ...
        <section >
            <div className=' max-w-[1440px] w-full mx-auto px-[24px] lg:px-[40px]  '>
                ...
                <div className="flex items-end gap-[40px] pt-[56px] pb-[80px] lg:flex-row flex-col-reverse">
                    <button onClick={() => {
                        setIsOpen(true)
                    }} className="lg:mb-[165px] md:w-full border-[2px] border-[#00032E] flex items-center justify-center gap-[8px] rounded-full py-[16px]  px-[24px] mx-auto max-w-[600px] font-[500] text-[20px] text-[#00032E]">{localization.header.btn}
